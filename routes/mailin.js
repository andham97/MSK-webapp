...
module.exports = rest.service(function(base_url,api_key,timeout) {
     ...
     */
    create_child_account:function(data) {
     ...
     */
    update_child_account:function(data) {
     ...
     */
    delete_child_account:function(data) {
        return this.delete_request("account/" + data['auth_key'],"");
    },
     ...
     */
    get_reseller_child:function(data) {
    ...
    /*
     ...
     - sms_credit {Integer} Number of sms credts
     */
    add_remove_child_credits:function(data) {
     ...
     */
    create_sms_campaign:function(data) {
        return this.post_request("sms",JSON.stringify(data));
    },
    ...
    /*
     ...
     @options data {Integer} send_now: Flag to send campaign now. Possible values = 0 (default) & 1. send_now = 0 means campaign can’t be send now, & send_now = 1 means campaign ready to send now [Optional]
     */
    update_sms_campaign:function(data) {
        id = data['id'];
        delete data['id'];
     ...
     */
    send_bat_sms:function(data) {
        id = data['id'];
        delete data['id'];
        return this.get_request("sms/" + id,JSON.stringify(data));
    },
     ...
     */
    get_campaigns_v2:function(data) {
     ...
     */
    campaign_report_email:function(data) {
        id = data['id'];
        delete data['id'];
     ...
     */
    campaign_recipients_export:function(data) {
        id = data['id'];
        delete data['id'];
     ...
     */
    send_bat_email:function(data) {
        id = data['id'];
        delete data['id'];
        return this.post_request("campaign/" + id + "/test",JSON.stringify(data));
    },
    ...
    /*
     ...
     @options data {Integer} send_now: Flag to send campaign now. Possible values = 0 (default) & 1. send_now = 0 means campaign can’t be send now, & send_now = 1 means campaign ready to send now [Optional]
     */
    create_trigger_campaign:function(data) {
        return this.post_request("campaign",JSON.stringify(data));
    },
    ...
    /*
     ...
     @options data {Integer} send_now: Flag to send campaign now. Possible values = 0 (default) & 1. send_now = 0 means campaign can’t be send now, & send_now = 1 means campaign ready to send now [Optional]
     */
    update_trigger_campaign:function(data) {
        id = data['id'];
        delete data['id'];
        return this.put_request("campaign/" + id,JSON.stringify(data));
    },
     ...
     */
    update_campaign_status:function(data) {
        id = data['id'];
        delete data['id'];
     ...
     */
    display_list_users:function(data) {
     ...
     */
    delete_users_list:function(data) {
        id = data['id'];
        delete data['id'];
     ...
     */
    create_update_user:function(data) {
     ...
     */
    get_attribute:function(data) {
        type = data['type'];
        return this.get_request("attribute/" + type,"");
    },
     ...
     */
    create_attribute:function(data) {
     ...
     */
    delete_attribute:function(data) {
        type = data['type'];
        delete data['type'];
